...
public class TestConfig implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Order o1 = new Order(null, Instant.parse("2022-10-22T22:22:22Z"),u1);
		Order o2 = new Order(null,Instant.parse("2002-09-23T23:44:12Z"),u2);
		Order o3 = new Order(null, Instant.parse("2019-04-29T10:00:00Z"),u1);
